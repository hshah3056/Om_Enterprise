...
class HelpdeskTicket(models.Model):
    ...
    upload_video = fields.Binary(string='Upload Video',copy=False,attachment=True, max_width=1024, max_height=1024)
    upload_image_1= fields.Image(
        string="Image",
        copy=False, attachment=True, max_width=1024, max_height=1024)
    upload_image_2 = fields.Image(
        string="Image",
        copy=False, attachment=True, max_width=1024, max_height=1024)

    # Address fields
    street = fields.Char('Street', related='partner_id.street', readonly=False, store=True)
    street2 = fields.Char('Street2', related='partner_id.street2', readonly=False, store=True)
    zip = fields.Char('Zip', related='partner_id.zip', readonly=False, store=True)
    city = fields.Char('City', related='partner_id.city', readonly=False, store=True)
    state_id = fields.Many2one(
        "res.country.state", string='State',
        related='partner_id.state_id', readonly=False, store=True,)
    country_id = fields.Many2one(
        'res.country', string='Country',
        related='partner_id.country_id', readonly=False, store=True)
    website = fields.Char('Website', help="Website of the contact", related='partner_id.website', readonly=False,store=True)
    phone = fields.Char(
        'Phone', tracking=50,
        related='partner_id.phone', readonly=False, store=True)
